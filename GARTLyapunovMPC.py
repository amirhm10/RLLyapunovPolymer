...
# predictable folder.
TIMESTAMP = None
TARGET_ONLY_OVERRIDES = GART_DX_ABS_0P05_ADAPTIVE_DYABS0P1_OVERRIDES
...
CASE_SPECS = [
    ...
    {
        "enabled": True,
        "case_name": "gart_target_raw_dxabs0p05_adaptive0p25_min0p10_dyabs0p1_no_umid",
        "objective": "raw",
        "lyapunov_mode": "hard",
        "target_overrides": GART_DX_ABS_0P05_ADAPTIVE_DYABS0P1_OVERRIDES,
        "label": "GART raw, absolute dx_s_max 0.05, absolute dy_s_max 0.1, adaptive d_c projection radius 0.25 min scale 0.10, no x/y smoothing, no u_mid, 1% headroom",
    },
    {
        "enabled": True,
        "case_name": "gart_target_raw_dxabs0p05_symmetric_dyabs0p1_no_umid",
        "objective": "raw",
        "lyapunov_mode": "hard",
        "target_overrides": GART_DX_ABS_0P05_SYMMETRIC_DYABS0P1_OVERRIDES,
        "label": "GART raw, absolute dx_s_max 0.05, absolute dy_s_max 0.1, fixed symmetric d_c rate scale 1.0, no x/y smoothing, no u_mid, 1% headroom",
    },
    {
        "enabled": False,
