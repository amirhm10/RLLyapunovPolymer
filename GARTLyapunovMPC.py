...
# predictable folder.
TIMESTAMP = None
TARGET_ONLY_OVERRIDES = GART_DX_ABS_0P1_DY2_OVERRIDES
...
CASE_SPECS = [
    ...
    },
    {
        ...
        "label": "GART raw, absolute dx_s_max 0.1, no x/y smoothing, no u_mid, 1% headroom, dy scale 2",
    },
    {
        "enabled": False,
