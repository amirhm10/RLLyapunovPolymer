...
# Continue online training from the same saved seed agent with the GART-LMPC
# safety gate active. No teacher warm-up, behavior-cloning phase, or handoff
# phase is used.
METHODS = (
...
def run_configured_study() -> dict:
    return run_configured_cycle_study(
        methods=METHODS,
        timestamp_label="cycle_phase1dist_saved_agent_safety_gate",
