...
- no immediate target-selection change is required for the fixed-epsilon practical proof, but the future vanishing-epsilon proof should account for target motion or add a small continuity tie-breaker if target non-uniqueness causes jumps
