...
TARGET_ABLATION_CASES: list[dict[str, Any]] = [
    ...
    {
        "name": "T6_dx_abs_0p05_symmetric_dyabs0p1_no_xy_smooth_no_umid",
        "overrides": GART_DX_ABS_0P05_SYMMETRIC_DYABS0P1_OVERRIDES,
    },
    {
        "name": "T6b_dx_abs_0p05_adaptive_dyabs0p1_no_xy_smooth_no_umid",
        "overrides": GART_DX_ABS_0P05_ADAPTIVE_DYABS0P1_OVERRIDES,
    },
    {
