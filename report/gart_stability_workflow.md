...
If no positive governed move can be certified, the previous accepted target is held:
...
This hold action is not treated as a successful move toward the new setpoint. It means that the safest certified target at the current time is the previous one. As the plant state moves closer to the held target, a positive value of $\alpha$ may become admissible at a subsequent time step.
