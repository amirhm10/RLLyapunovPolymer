...
\sloppy
\title{Guarded Admissible Reachable Target Stability Workflow}
\author{}
\date{}
\begin{document}
\maketitle
...
\section*{1. Output-Disturbance Target Model}
...
\section*{2. Certified Disturbance Projection}
...
\section*{3. Consequence For Target Motion}
...
\section*{4. Reachable Equilibrium Target Set}
...
\section*{5. Input Headroom And Tightened Steady Inputs}
...
\section*{6. Motivation For Lexicographic Target Optimization}
...
\section*{7. Stage 1: Closest Reachable Output}
...
\section*{8. Stage 2: Tie-Breaking Inside The Primary-Cost Shell}
...
\section*{9. Tracking Error Decomposition}
...
\section*{10. Contraction-Admissible Target Check}
...
\section*{11. Constraint-Aware Dynamic Governor}
...
\section*{12. Final GART-LMPC Optimization}
...
\textbf{Assumption 2: Accepted target sequence.}
...
\textbf{Assumption 3: Certified executed input.}
...
\textbf{Assumption 4: Successful certified step.}
...
\textbf{Assumption 5: Bounded model/estimator residual for external tracking.}
...
\section*{13. Moving-Target Practical Stability Bound}

\textbf{Theorem 1: Practical target-centered stability of GART-LMPC.}
...
\section*{14. Raw Setpoint Tracking Bound}

\textbf{Corollary 1: Raw-setpoint tracking interpretation.}
...
\section*{15. Interpretation Of The Stability Claim}
...
\begin{itemize}
\item the controller-to-target stability tube;
\item the target-to-setpoint displacement caused by reachability and governor action;
\item the residual estimator/model mismatch.
\end{itemize}
...
\section*{16. GART-Aware Reinforcement Learning Step}
...
\textbf{Proposition 1: RL exploration under the GART safety projection.}
...
\section*{Parameter And Notation Table}
...
\begin{longtable}{>{\raggedright\arraybackslash}p{0.18\textwidth}>{\raggedright\arraybackslash}p{0.27\textwidth}>{\raggedright\arraybackslash}p{0.22\textwidth}>{\raggedright\arraybackslash}p{0.23\textwidth}}
\toprule
...
\texttt{terminal\_set\_on} & Terminal-set enable flag & \texttt{True} & Final runner enables the terminal set conditionally through $\alpha_s>\alpha_{\min}$ \\
...
$\sigma_d$ & Disturbance-rate scaling factor & $1.0$ & Fixed symmetric setting; implementation parameter \texttt{d\_rate\_scale} \\
...
$W_c$ & RL action-projection correction weight & Identity by default & Implementation parameter \texttt{candidate\_weight\_diag} \\
